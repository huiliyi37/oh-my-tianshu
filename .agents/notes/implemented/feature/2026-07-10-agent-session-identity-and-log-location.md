...
- `DSH_HOME` is always the absolute configured Harness home. The standalone [`@huiliyi37/dsh-paths`](../../../../packages/util/paths/README.md) utility owns its precedence: explicit `dshHome`, then ambient `$DSH_HOME`, then `~/.dsh`.
