...
- Package-level tests: 91 all green (prediction 18 / router 12 / dispatch 8 / integration 15 / invariant 17 / synthesis 9 / budget 6 / promotion 6).
...
```sh
pnpm vitest run packages/guard/agent-router/tests/                     # 8 文件 91 测试全绿
