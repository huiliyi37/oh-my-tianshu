...
Every composition that loads a bash executor now also loads `@huiliyi37/dsh-subprocess-local` (CLI, examples, python bundled runtime, create-sdk's bash feature resources, inline test configs).
