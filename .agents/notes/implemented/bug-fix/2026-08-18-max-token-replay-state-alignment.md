...
English | [中文](2026-08-18-max-token-replay-state-alignment.zh.md)

Ported from upstream deepseek-ai/deepseek-harness `7e95a00c8` (dsh-v0.1.0-rc.7 bug-fix backport); assembler, replay, adapter, and continuation tests ported alongside.
