...
[English](2026-08-18-max-token-replay-state-alignment.md) | 中文

移植自上游 deepseek-ai/deepseek-harness `7e95a00c8`（dsh-v0.1.0-rc.7 缺陷修复回移）；assembler、回放、适配器与续接测试一并移植。
