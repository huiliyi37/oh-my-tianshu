...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@huiliyi37/dsh-agent-loop`.
- No cross-package deep imports (`@huiliyi37/dsh-*/src/...` paths) — public entry points only.
