...
// Empty type import carries the userInteraction Context merge.
import type {} from '@huiliyi37/dsh-user-interaction'
import {
...
describe('web e2e: resident question composer round trip', () => {
  ...
  // count — so it is asked straight through the user-interaction seam (the same
  ...
  it.skipIf(MODE === 'record')('grows the optionless answer to the same cap', async () => {
    ...
    const asked = scaffold.ctx.userInteraction.ask({
