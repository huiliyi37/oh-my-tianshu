/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-checkpoint-policy`.
 * @module @huiliyi37/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-checkpoint-policy'
