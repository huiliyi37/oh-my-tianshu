/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-stats`.
 * @module @huiliyi37/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-stats'
