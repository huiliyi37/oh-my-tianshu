/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-title-all-messages-llm`.
 * @module @huiliyi37/dsh-session-title-all-messages-llm/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-title-all-messages-llm'
