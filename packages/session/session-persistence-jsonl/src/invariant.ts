/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-persistence-jsonl`.
 * @module @huiliyi37/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-persistence-jsonl'
