/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-persistence`.
 * @module @huiliyi37/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-persistence'
