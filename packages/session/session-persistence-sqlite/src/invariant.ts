/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-persistence-sqlite`.
 * @module @huiliyi37/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-persistence-sqlite'
