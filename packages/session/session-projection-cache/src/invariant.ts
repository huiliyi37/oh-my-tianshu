/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-projection-cache`.
 * @module @huiliyi37/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-projection-cache'
