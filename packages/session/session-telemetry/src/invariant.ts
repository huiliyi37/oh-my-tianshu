/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-telemetry`.
 * @module @huiliyi37/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-telemetry'
