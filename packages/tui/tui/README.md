...
- Panel projections (`projectXxxPanel`) are pure functions; the pending-state state machines are extracted into controllers (`src/controllers/`, see docs/tui-controllers.md), which keep thinning app.ts
