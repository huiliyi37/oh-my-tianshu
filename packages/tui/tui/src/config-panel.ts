 ...
 * 其他维度独占）。
 *
 * @module @huiliyi37/dsh-tianshu-tui/config-panel
 */
...
function formatValue(value: unknown): string {
  ...
  switch (typeof value) {
    ...
    default:
      ...
      // oxlint-disable-next-line typescript/no-unnecessary-type-assertion -- JSON-shaped object 值恒可序列化；断言对齐 TS/oxlint 的类型模型差异
