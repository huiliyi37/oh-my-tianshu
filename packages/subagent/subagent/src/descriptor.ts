 ...
 *
 * @module @huiliyi37/dsh-subagent/descriptor
 */
...
function parseToolFilter(value: unknown): ToolRestriction {
  ...
  if (allow === undefined && deny === undefined) throw new Error('persisted subagent descriptor toolFilter must declare allow and/or deny')
  return {
