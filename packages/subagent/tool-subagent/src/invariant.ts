/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-subagent`.
 * @module @huiliyi37/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-subagent'
