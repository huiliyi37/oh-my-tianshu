...
Spawn advertises `{ outputSchema: true, depthLimit: true, toolFilter: true, persona: true, sandboxMode: true }` because it controls the child's creation window and can enforce all five features.
