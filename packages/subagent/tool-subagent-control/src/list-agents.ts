 ...
 * @module @huiliyi37/dsh-tool-subagent-control/list-agents
 */
...
import type { SubagentDescendantListEntry, SubagentListEntry } from '@huiliyi37/dsh-subagent'
...
function statusOf(agents: { get(id: SessionId): Agent | undefined }, id: SessionId): 'running' | 'idle' | 'complete' {
  ...
  return agent.status !== 'running' ? 'idle' : 'running'
}
