/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-subagent-control`.
 * @module @huiliyi37/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-subagent-control'
