/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-subagent-report`.
 * @module @huiliyi37/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-subagent-report'
