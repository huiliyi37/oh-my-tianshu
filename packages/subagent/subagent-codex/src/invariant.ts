/**
 * Package-owned invariant companion for `@huiliyi37/dsh-subagent-codex`.
 * @module @huiliyi37/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-subagent-codex'
