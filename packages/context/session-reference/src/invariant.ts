/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-reference`.
 * @module @huiliyi37/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-reference'
