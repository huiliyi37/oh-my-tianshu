/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tmux-context`.
 * @module @huiliyi37/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tmux-context'
