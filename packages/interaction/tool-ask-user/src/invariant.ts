/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-ask-user`.
 * @module @huiliyi37/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-ask-user'
