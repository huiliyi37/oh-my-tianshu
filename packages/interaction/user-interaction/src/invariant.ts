/**
 * Package-owned invariant companion for `@huiliyi37/dsh-user-interaction`.
 * @module @huiliyi37/dsh-user-interaction/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-user-interaction'
