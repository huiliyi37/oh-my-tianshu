/**
 * Package-owned invariant companion for `@huiliyi37/dsh-workspace`.
 * @module @huiliyi37/dsh-workspace/invariant
 */

import type { Context } from '@huiliyi37/cordis'
import type { InvariantInstaller } from '@huiliyi37/dsh-invariants'
import type { DomainChanged } from '@huiliyi37/dsh-storage-domain'
import { WorkspaceId } from '@huiliyi37/dsh-workspace'

const PACKAGE_NAME = '@huiliyi37/dsh-workspace'
