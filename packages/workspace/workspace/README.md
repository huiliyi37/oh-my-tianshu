# @huiliyi37/dsh-workspace

English | [中文](README.zh.md)

Workspace entity registry (`ctx.workspace`) for the Tianshu Harness: durable workspace records, stable workspace order, and a newest-first candidate session index stored through the domain data form. Consumers see the `Workspace` interface; the entity implementation stays package-private.
