...
import { en as commonEn, zh as commonZh } from '@huiliyi37/dsh-client-locale/src/locales/index.ts'
...
describe('ContextMeter', () => {
  ...
  it('closes when capacity disappears and stays closed when it returns', () => {
    ...
    const view = render(<ContextMeter useProjection={(key: string) => { return values[key] }} t={t} />)
    fireEvent.click(view.getByRole('button', { name: '上下文已用 25%' }))
