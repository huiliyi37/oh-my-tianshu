...
import type { SessionBehaviorOverrides } from '@huiliyi37/dsh-client-test-runtime'
...
import { apply, inject } from '@huiliyi37/dsh-client-ui-conversation/client'
import type {
...
describe('conversation slot inject surface', () => {
  ...
  it('openFile (chat view face) resolves against session cwd and calls workspaces.openPath', async () => {
    ...
    void injected.openFile('src/a.ts')
    await vi.waitFor(() => {
