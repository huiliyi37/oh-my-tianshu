 ...
 */
import type { CommandClaim, ReferenceInsert, TokenSpan } from '@huiliyi37/dsh-client-ui-slash/client'
...
export class InputMachine {
  ...
  private withMinted(minted: readonly Occurrence[]): void {
    ...
    this.occurrences = [...this.occurrences, ...minted].sort((a, b) => { return a.offset - b.offset })
  }
