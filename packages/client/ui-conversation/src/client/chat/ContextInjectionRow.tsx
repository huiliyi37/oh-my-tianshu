...
import type { ContextMessageNode } from '@huiliyi37/dsh-client-runtime/client'
import type { ChatViewSlotProps } from '../contract/slots.ts'
import { DisclosureRow, IconBrowseOutline16 } from '@huiliyi37/dsh-client-ui-primitives'
...
export function ContextInjectionRow({ content, source, provenance, form, t }: ContextInjectionRowProps) {
  ...
  return (
    <DisclosureRow
      ...
      title={t(provenance.role !== 'recall' ? 'message.contextInjection' : 'message.contextRecall')}
