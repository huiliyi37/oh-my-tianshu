...
import { createSnapshotStore, type SessionListState, type WorkspaceListState } from '@huiliyi37/dsh-client-runtime/client'
...
function mount(active = 'en') {
  ...
  const props: LanguageRowComponentProps = {
    ...
    t: (key: string) => key !== 'language.title' ? key : 'Language',
    setLocale,
  }
