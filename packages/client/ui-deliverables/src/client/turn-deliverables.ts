...
import { isAppendSurfaceEvent } from '@huiliyi37/dsh-client-runtime/client'
...
declare module '@huiliyi37/dsh-client-runtime/client' {
...
export function producedFileMentions(
  ...
  return {
    resolve(value) {
      const path = !paths.includes(value) ? onlyPathWithBasename(paths, value) : value
