/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-model`.
 * @module @huiliyi37/dsh-client-ui-model/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-model'
