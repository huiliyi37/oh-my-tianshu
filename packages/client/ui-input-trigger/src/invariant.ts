/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-input-trigger`.
 * @module @huiliyi37/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-input-trigger'
