...
import type { IndexInjection } from '@huiliyi37/dsh-host-webserver'
import { Settings as SettingsProvider, settingsNamespace, type SettingsNamespace } from '@huiliyi37/dsh-settings'
import {
  DEFAULT_PREFERENCE, THEME_SETTINGS_NAMESPACE, apply,
} from '@huiliyi37/dsh-client-ui-theme'
