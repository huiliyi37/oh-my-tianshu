/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-sidebar`.
 * @module @huiliyi37/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-sidebar'
