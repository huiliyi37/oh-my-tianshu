/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-layout`.
 * @module @huiliyi37/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-layout'
