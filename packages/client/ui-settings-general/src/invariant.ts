/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-settings-general`.
 * @module @huiliyi37/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-settings-general'
