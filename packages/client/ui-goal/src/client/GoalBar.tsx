...
import type { GoalSnapshot } from '@huiliyi37/dsh-goal/client'
import {
...
export type GoalDockProps = import('@huiliyi37/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
