/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-goal`.
 * @module @huiliyi37/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-goal'
