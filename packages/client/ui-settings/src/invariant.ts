/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-settings`.
 * @module @huiliyi37/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-settings'
