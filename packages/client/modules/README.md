...
- **No unload bookkeeping of its own** — style removal and fiber teardown ordering live with the HMR driver (`@huiliyi37/dsh-client-hmr`); the loader only inventories owned style tag ids per record.
