/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-modules`.
 * @module @huiliyi37/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-modules'
