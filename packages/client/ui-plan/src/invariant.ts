/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-plan`.
 * @module @huiliyi37/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-plan'
