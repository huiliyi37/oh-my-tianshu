...
import type { WebBootGraph, ClientModuleHostService } from '@huiliyi37/dsh-client-modules'
import type { WebRoute, HttpServerService } from '@huiliyi37/dsh-host-webserver'
...
function fakeClientModuleHost(rows: Map<string, string>, options: FakeHostOptions = {}): FakeHost {
  ...
  const rebuiltCalls: Array<string> = []
