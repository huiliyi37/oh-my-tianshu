...
import type { ActionsDecl, SlotEntryDef, SlotSpec, StoreHandle, StoredEntry } from '@huiliyi37/dsh-client-ui-slots'
import type { SessionMaybeProvideInfo } from '@huiliyi37/dsh-client-ui-slots'
import {
...
} from '@huiliyi37/dsh-client-web-react'
  ...
  it('hands the SessionProvider seat to entries declaring a session-scope child', () => {
    ...
    h.add('root', {
      component: (props: AnyProps) => {
        ...
        const renderSlot: RenderSlotFn = props['renderSlot'] as RenderSlotFn
        return (
