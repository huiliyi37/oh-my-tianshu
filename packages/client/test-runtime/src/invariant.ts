/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-test-runtime`.
 * @module @huiliyi37/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-test-runtime'
