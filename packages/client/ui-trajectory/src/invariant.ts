/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-trajectory`.
 * @module @huiliyi37/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-trajectory'
