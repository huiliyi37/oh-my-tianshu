/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-workspace`.
 * @module @huiliyi37/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-workspace'
