 ...
 * @module
 */
import { resolveWorkspacePath } from '@huiliyi37/dsh-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@huiliyi37/dsh-client-ui-primitives'
