/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-tool`.
 * @module @huiliyi37/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-tool'
