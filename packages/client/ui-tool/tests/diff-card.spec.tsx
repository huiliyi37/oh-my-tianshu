...
import type { ToolCallView, ToolResultView } from '@huiliyi37/dsh-client-connection/client'
...
describe('FileMutationRow diff card', () => {
  const list = () => createSnapshotStore<SessionListState>({
    ids: [SID],
    byId: { [SID]: { id: SID, displayTitle: 'r', running: false, version: 0, blank: false, updatedAt: 0, cwd: '/w/app' } },
    current: SID,
    phase: 'ready',
    subagentsByParent: {},
...
describe('DetailsPanel diff Output section', () => {
  function mount(snapshot: ConversationSnapshot, selection: SelectionTarget | null, cwd?: string) {
    ...
    const sessions = createSnapshotStore<SessionListState>(cwd === undefined
      ...
      : {
        ids: [SID],
        byId: { [SID]: { id: SID, displayTitle: 'r', running: false, version: 0, blank: false, updatedAt: 0, cwd } },
        current: SID,
        phase: 'ready',
        subagentsByParent: {},
        currentAddress: undefined,
