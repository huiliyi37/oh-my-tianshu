...
import type { ConversationSnapshot, ToolResultNode } from '@huiliyi37/dsh-client-runtime/client'
...
function props(
  ...
  const useSession = ((selector: (value: ConversationSnapshot) => unknown) => { return selector(snapshot) }) as ToolTreeProps['useSession']
