...
import type { RunningToolCall, SessionId, SessionListState, ToolResultNode } from '@huiliyi37/dsh-client-runtime/client'
...
function listStore() {
  return createSnapshotStore<SessionListState>({
    ids: [SID],
    byId: {
      [SID]: { id: SID, title: 'r', displayTitle: 'r', running: false, version: 0, blank: false, updatedAt: 0 },
    },
    current: undefined,
    phase: 'ready',
    subagentsByParent: {},
