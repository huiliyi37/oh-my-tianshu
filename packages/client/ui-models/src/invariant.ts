/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-models`.
 * @module @huiliyi37/dsh-client-ui-models/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-models'
