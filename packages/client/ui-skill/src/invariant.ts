/**
 * Package-owned invariant companion for `@huiliyi37/dsh-client-ui-skill`.
 * @module @huiliyi37/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-client-ui-skill'
