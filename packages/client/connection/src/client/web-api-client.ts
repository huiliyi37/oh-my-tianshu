...
import { hostFrameSchema, muxFrameSchema } from '@huiliyi37/dsh-host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@huiliyi37/dsh-host-apiproxy/api/rpc.schema'
