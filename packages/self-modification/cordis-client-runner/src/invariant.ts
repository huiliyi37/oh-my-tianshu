/**
 * Package-owned invariant companion for `@huiliyi37/dsh-cordis-client-runner`.
 * @module @huiliyi37/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-cordis-client-runner'
