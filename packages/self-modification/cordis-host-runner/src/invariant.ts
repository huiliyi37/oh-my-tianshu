/**
 * Package-owned invariant companion for `@huiliyi37/dsh-cordis-host-runner`.
 * @module @huiliyi37/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-cordis-host-runner'
