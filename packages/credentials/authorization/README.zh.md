...
import { AuthorizationDeclinedError, type AuthorizationSession } from '@huiliyi37/dsh-authorization'
import { credentialKey } from '@huiliyi37/dsh-credentials'
...
无：授权是配置期与人的对话，flow、notice 与 prompt 都不会抵达模型请求。
