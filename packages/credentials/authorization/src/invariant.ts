/**
 * Package-owned invariant companion for `@huiliyi37/dsh-authorization`.
 * @module @huiliyi37/dsh-authorization/invariant
 */

import type { Context } from '@huiliyi37/cordis'
import type { InvariantFailure, InvariantInstaller } from '@huiliyi37/dsh-invariants'

const PACKAGE_NAME = '@huiliyi37/dsh-authorization'
