 ...
 * optional user patch layers from the Harness home (`~/.dsh-tianshu` by default), expose its path resolver to
...
export function loadLayeredEnv(
  ...
  const user = home !== resolve(cwd) ? readEnvLayer(binName, home, warn) : undefined
