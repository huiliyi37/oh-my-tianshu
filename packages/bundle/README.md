...
In-box bundles resolve from the dsh installation; out-of-tree bundles install into a profile through `oh-my-tianshu plugin --profile <name> add <package>`.
