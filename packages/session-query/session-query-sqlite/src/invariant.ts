/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-query-sqlite`.
 * @module @huiliyi37/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-query-sqlite'
