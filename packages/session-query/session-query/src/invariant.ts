/**
 * Package-owned invariant companion for `@huiliyi37/dsh-session-query`.
 * @module @huiliyi37/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-session-query'
