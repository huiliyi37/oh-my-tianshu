...
import type { ProcessInspectorInternals } from '@huiliyi37/dsh-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@huiliyi37/dsh-subprocess-local/src/windows-inspector.ts'
