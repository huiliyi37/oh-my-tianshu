/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-workflow`.
 * @module @huiliyi37/dsh-tool-workflow/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-workflow'
