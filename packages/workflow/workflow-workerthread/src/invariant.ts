/**
 * Package-owned invariant companion for `@huiliyi37/dsh-workflow-workerthread`.
 * @module @huiliyi37/dsh-workflow-workerthread/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-workflow-workerthread'
