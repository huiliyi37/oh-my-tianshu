...
import * as invariant from '@huiliyi37/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@huiliyi37/dsh-command-compact', expect.any(Function))
    expect(() => {
