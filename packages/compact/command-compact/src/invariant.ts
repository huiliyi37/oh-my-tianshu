/**
 * Package-owned invariant companion for `@huiliyi37/dsh-command-compact`.
 * @module @huiliyi37/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-command-compact'
