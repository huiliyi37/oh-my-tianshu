...
| `timeoutMs` | `30000` | Cooperative tool-call budget attached to both tool definitions, enforced by `@huiliyi37/dsh-timeout-guard` through `exec.signal`; the subprocess seam's terminate escalation is the hard kill. |
