 ...
 * model-facing render consumes ({@link module:@huiliyi37/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @huiliyi37/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@huiliyi37/dsh-tool-fs-search/grep} `formatGrepMatches`), so
