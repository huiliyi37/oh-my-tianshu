/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-fs-search`.
 * @module @huiliyi37/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-fs-search'
