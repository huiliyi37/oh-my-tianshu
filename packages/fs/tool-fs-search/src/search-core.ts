 ...
 *
 * @module @huiliyi37/dsh-tool-fs-search/search-core
 */
...
import { ItemRetainer, TextRetainer } from '@huiliyi37/dsh-retention'
import type { RetainedItems } from '@huiliyi37/dsh-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@huiliyi37/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@huiliyi37/dsh-spill'
import type { ToolExecution } from '@huiliyi37/dsh-tools'
 ...
 * retention pass both the model-facing render ({@link module:@huiliyi37/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@huiliyi37/dsh-tool-fs-search/presentation} `grepSearchMeta`)
