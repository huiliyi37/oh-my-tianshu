/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-str-replace-editor`.
 * @module @huiliyi37/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-str-replace-editor'
