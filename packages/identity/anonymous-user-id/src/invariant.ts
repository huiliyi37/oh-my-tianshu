/**
 * Package-owned invariant companion for `@huiliyi37/dsh-anonymous-user-id`.
 * @module @huiliyi37/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-anonymous-user-id'
