/**
 * Package-owned invariant companion for `@huiliyi37/dsh-agent-tool-presentation`.
 * @module @huiliyi37/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-agent-tool-presentation'
