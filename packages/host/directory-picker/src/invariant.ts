/** Package-owned invariant companion for the directory-picker seam. @module @huiliyi37/dsh-host-directory-picker/invariant */

import type { Context } from '@huiliyi37/cordis'
import type { InvariantInstaller } from '@huiliyi37/dsh-invariants'

const PACKAGE_NAME = '@huiliyi37/dsh-host-directory-picker'
