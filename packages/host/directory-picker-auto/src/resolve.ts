 ...
 * @module @huiliyi37/dsh-host-directory-picker-auto/resolve
 */

import type { Config as HttpServerConfig } from '@huiliyi37/dsh-host-webserver'
...
const present = (value: string | undefined): boolean => { return value !== undefined && value !== '' }
