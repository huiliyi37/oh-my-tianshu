/**
 * Package-owned invariant companion for `@huiliyi37/dsh-host-webserver`.
 * @module @huiliyi37/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-host-webserver'
