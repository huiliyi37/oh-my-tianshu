/**
 * Package-owned invariant companion for `@huiliyi37/dsh-host-apiproxy`.
 * @module @huiliyi37/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-host-apiproxy'
