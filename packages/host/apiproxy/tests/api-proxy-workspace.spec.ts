...
import type { Agent, AgentFactory } from '@huiliyi37/dsh-agent'
...
import { DomainFacility } from '@huiliyi37/dsh-storage-domain'
...
import type { DirectoryPickerCapability } from '@huiliyi37/dsh-host-directory-picker'
import WorkspaceRegistry from '@huiliyi37/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@huiliyi37/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@huiliyi37/dsh-host-apiproxy/api/rpc'
