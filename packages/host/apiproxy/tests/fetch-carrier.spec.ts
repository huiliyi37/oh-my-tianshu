  ...
  return {
    sessions: {
      ...
      async rewind(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { filesChanged: 0, truncatedTo: request.payload.atSeq } } }
      },
    },
    subagents: {
      async list(request) {
    ...
    host: {
      async describe(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { version: 'v', cwd: '/w', attachedSessions: 0, home: '/h' } } }
      },
