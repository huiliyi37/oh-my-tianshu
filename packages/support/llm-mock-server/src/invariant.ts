/**
 * Package-owned invariant companion for `@huiliyi37/dsh-llm-mock-server`.
 * @module @huiliyi37/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-llm-mock-server'
