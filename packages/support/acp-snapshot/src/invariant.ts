/**
 * Package-owned invariant companion for `@huiliyi37/dsh-acp-snapshot`.
 * @module @huiliyi37/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-acp-snapshot'
