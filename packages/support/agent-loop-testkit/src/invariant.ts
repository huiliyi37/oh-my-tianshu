/**
 * Package-owned invariant companion for `@huiliyi37/dsh-agent-loop-testkit`.
 * @module @huiliyi37/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-agent-loop-testkit'
