/**
 * Package-owned invariant companion for `@huiliyi37/dsh-loader-smoke`.
 * @module @huiliyi37/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-loader-smoke'
