/**
 * Package-owned invariant companion for `@huiliyi37/dsh-pwsh-sandbox`.
 * @module @huiliyi37/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-pwsh-sandbox'
