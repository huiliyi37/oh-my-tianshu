/**
 * Package-owned invariant companion for `@huiliyi37/dsh-hooks-claude`.
 * @module @huiliyi37/dsh-hooks-claude/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-hooks-claude'
