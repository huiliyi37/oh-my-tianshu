 ...
 * @module @huiliyi37/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@huiliyi37/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@huiliyi37/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@huiliyi37/dsh-*` row would fail to import. The
