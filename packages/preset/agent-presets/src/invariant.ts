/**
 * Package-owned invariant companion for `@huiliyi37/dsh-agent-presets`.
 * @module @huiliyi37/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@huiliyi37/dsh-agent-presets'

const PACKAGE_NAME = '@huiliyi37/dsh-agent-presets'
