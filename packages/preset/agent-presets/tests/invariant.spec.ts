...
import AgentRegistry, { assembleContextFor } from '@huiliyi37/dsh-agent'
import AgentLoop from '@huiliyi37/dsh-agent-loop'
import InvariantRegistry from '@huiliyi37/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@huiliyi37/dsh-agent-presets'
import * as AgentPresetsInvariant from '@huiliyi37/dsh-agent-presets/invariant'
