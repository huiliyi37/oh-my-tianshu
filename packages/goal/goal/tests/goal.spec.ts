...
import AgentRegistry, { agentEvents, Inbox } from '@huiliyi37/dsh-agent'
import type { Agent } from '@huiliyi37/dsh-agent'
import { createUserMessage, HarnessError } from '@huiliyi37/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@huiliyi37/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@huiliyi37/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@huiliyi37/dsh-session').SessionEvent[]): StubAgent {
