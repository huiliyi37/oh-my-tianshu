/**
 * Package-owned invariant companion for `@huiliyi37/dsh-command-goal`.
 * @module @huiliyi37/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-command-goal'
