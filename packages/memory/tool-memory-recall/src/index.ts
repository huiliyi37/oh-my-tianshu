/**
 * tool-memory-recall — memory_deep_recall：reader 子代理的按需原始历史召回（mode C）。
 *
 * 设计契约：Agent Note
 * `.agents/notes/implemented/feature/2026-08-18-tool-memory-recall.md`。
 * 原始历史只由 reader 子代理阅读，返回固定蒸馏形状
