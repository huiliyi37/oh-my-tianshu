/**
 * Package-owned invariant companion for `@huiliyi37/dsh-typert-registry`.
 * @module @huiliyi37/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-typert-registry'
