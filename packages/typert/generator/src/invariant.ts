/**
 * Package-owned invariant companion for `@huiliyi37/dsh-typert-generator`.
 * @module @huiliyi37/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-typert-generator'
