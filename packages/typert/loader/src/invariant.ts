/**
 * Package-owned invariant companion for `@huiliyi37/dsh-typert-loader`.
 * @module @huiliyi37/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-typert-loader'
