...
| [`guard/`](guard/README.md) | Loop-hygiene guards: repeat-call reminders, tool deadlines, the zen first-face phase, the first-message task-card rewrite | Product — stable surface |
