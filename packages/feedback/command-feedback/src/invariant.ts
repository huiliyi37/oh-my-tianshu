/**
 * Package-owned invariant companion for `@huiliyi37/dsh-command-feedback`.
 * @module @huiliyi37/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-command-feedback'
