 ...
 * @module @huiliyi37/dsh-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@huiliyi37/cordis'
import s from '@huiliyi37/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@huiliyi37/dsh-session/surface'
import type { SessionHeader, SessionId } from '@huiliyi37/dsh-session/types'
import type { SessionInspection } from '@huiliyi37/dsh-session-persistence'
import type { KvTable } from '@huiliyi37/dsh-storage-domain'
