/**
 * Package-owned invariant companion for `@huiliyi37/dsh-atomic-write`.
 * @module @huiliyi37/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-atomic-write'
