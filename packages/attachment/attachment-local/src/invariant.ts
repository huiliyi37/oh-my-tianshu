/** Package-owned invariant companion for `@huiliyi37/dsh-attachment-local`. @module @huiliyi37/dsh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@huiliyi37/cordis'
import type { InvariantInstaller } from '@huiliyi37/dsh-invariants'

const PACKAGE_NAME = '@huiliyi37/dsh-attachment-local'
