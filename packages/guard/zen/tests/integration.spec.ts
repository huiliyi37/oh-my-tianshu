 ...
 * predicates (including the /fast user skip), prompt-section pruning that
 * follows the assembly's face, and deferred arming against a still-filling
 * tool registry. Only the model is mocked; the loop, the session
