/**
 * Package-owned invariant companion for `@huiliyi37/dsh-repeat-tool-guard`.
 * @module @huiliyi37/dsh-repeat-tool-guard/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-repeat-tool-guard'
