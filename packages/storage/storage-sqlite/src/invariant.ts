/**
 * Package-owned invariant companion for `@huiliyi37/dsh-storage-sqlite`.
 * @module @huiliyi37/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-storage-sqlite'
