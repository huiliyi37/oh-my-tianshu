/**
 * Package-owned invariant companion for `@huiliyi37/dsh-storage-domain`: every
 ...
 * @module @huiliyi37/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-storage-domain'
