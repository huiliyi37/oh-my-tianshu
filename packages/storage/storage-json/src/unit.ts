 ...
 * @module @huiliyi37/dsh-storage-json/src/unit
 */

import { readFile } from 'node:fs/promises'
import { StorageError } from '@huiliyi37/dsh-storage'
import type { KvUnit, KvUnitDescriptor } from '@huiliyi37/dsh-storage'
...
class JsonKvUnit implements KvUnit {
  ...
  private publish(): Promise<void> {
    ...
    write.catch(() => {}).finally(() => { return this.inFlight.delete(write) })
    return write
  }
}
