/**
 * Package-owned invariant companion for `@huiliyi37/dsh-storage-json`.
 * @module @huiliyi37/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-storage-json'
