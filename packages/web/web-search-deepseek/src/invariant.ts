/**
 * Package-owned invariant companion for `@huiliyi37/dsh-web-search-deepseek`.
 * @module @huiliyi37/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-web-search-deepseek'
