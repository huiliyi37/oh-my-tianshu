...
import { ExaSearchProvider, EXA_DEFAULT_BASE_URL, EXA_DEFAULT_HIGHLIGHTS_PER_RESULT, EXA_DEFAULT_SEARCH_TYPE } from '@huiliyi37/dsh-web-search-exa'
...
maybe('ExaSearchProvider real API', () => {
  it('returns sources for a live query', async () => {
    ...
    const result = await provider.search({ query: 'Tianshu Harness SDK', maxResults: 5 })
