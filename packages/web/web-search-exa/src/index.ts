/**
 * `@huiliyi37/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@huiliyi37/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@huiliyi37/dsh-web`.
 *
 * @module @huiliyi37/dsh-web-search-exa
 */
