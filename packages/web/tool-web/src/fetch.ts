...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@huiliyi37/dsh-tools'
 ...
 * `@huiliyi37/dsh-timeout-guard`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@huiliyi37/dsh-timeout-guard` to enforce.
