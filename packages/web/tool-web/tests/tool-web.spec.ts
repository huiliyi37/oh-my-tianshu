...
import type { WebSearchProvider, WebSearchResult } from '@huiliyi37/dsh-web'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@huiliyi37/dsh-web').WebFetchProvider
