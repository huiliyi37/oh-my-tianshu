 ...
 * `@huiliyi37/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @huiliyi37/dsh-web-fetch-local/provider
 */

import { WebError } from '@huiliyi37/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@huiliyi37/dsh-web'
