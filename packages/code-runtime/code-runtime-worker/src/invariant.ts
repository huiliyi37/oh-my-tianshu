/**
 * Package-owned invariant companion for `@huiliyi37/dsh-code-runtime-worker`.
 * @module @huiliyi37/dsh-code-runtime-worker/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-code-runtime-worker'
