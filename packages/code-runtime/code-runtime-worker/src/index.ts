 ...
 * @module @huiliyi37/dsh-code-runtime-worker
 */
...
import { CodeRuntime, DUNDER_MEMBER, PORTABLE_RESERVED_WORDS, RESERVED_BINDING_GLOBALS, RESERVED_ERROR_MEMBERS } from '@huiliyi37/dsh-code-runtime'
import type { CodeBindingNamespace, CodeJsonValue, CodeRunFailure, CodeRunRequest, CodeRunResult } from '@huiliyi37/dsh-code-runtime'
    ...
    return new Promise<CodeRunResult>((resolve) => {
      ...
      const onDone = (message: WorkerToHost): void => {
        ...
        if (value === undefined) {
          ...
          finish(() => { return output.success([...logs, ...strayLogs], value) })
        }
      }
