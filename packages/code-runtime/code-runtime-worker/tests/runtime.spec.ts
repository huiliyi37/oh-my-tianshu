...
import type { Config } from '@huiliyi37/dsh-code-runtime-worker'
import type { CodeBindingFunction, CodeBindingNamespace, CodeRunResult } from '@huiliyi37/dsh-code-runtime'
