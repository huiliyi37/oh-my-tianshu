...
[`@huiliyi37/dsh-code-runtime`](../code-runtime/README.md) seam 的 CPython 子进程实现。与 [`@huiliyi37/dsh-code-runtime-worker`](../code-runtime-worker/README.md) 配套；以全新的 `python3` 子进程取代 Node worker 线程，让模型代码从 TypeScript 换成 Python。
