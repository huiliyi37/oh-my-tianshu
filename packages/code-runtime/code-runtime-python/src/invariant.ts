/**
 * Package-owned invariant companion for `@huiliyi37/dsh-code-runtime-python`.
 * @module @huiliyi37/dsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-code-runtime-python'
