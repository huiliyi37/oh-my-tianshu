# @huiliyi37/dsh-code-runtime-python

English | [中文](README.zh.md)

CPython-subprocess implementation of the [`@huiliyi37/dsh-code-runtime`](../code-runtime/README.md) seam. Companion to [`@huiliyi37/dsh-code-runtime-worker`](../code-runtime-worker/README.md); trades the Node worker thread for a fresh `python3` subprocess so model code is Python instead of TypeScript.
