...
| [`cache-diagnostic/`](cache-diagnostic/README.md) | 前缀缓存健康观测与未命中诊断 | `ctx.cacheDiagnostic` |
...
| [`tool-json-repair/`](tool-json-repair/README.md) | 修复 DeepSeek 工具 JSON 落入 content 的形态 | 包裹 `llm/stream` |
