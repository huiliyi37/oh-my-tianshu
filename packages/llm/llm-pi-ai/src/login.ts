...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@huiliyi37/dsh-authorization'
import { isCredentialKeySegment } from '@huiliyi37/dsh-credentials'
