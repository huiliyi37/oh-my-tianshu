...
import AuthorizationService from '@huiliyi37/dsh-authorization'
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@huiliyi37/dsh-authorization'
import CredentialsLocal from '@huiliyi37/dsh-credentials-local'
import type { CredentialKey } from '@huiliyi37/dsh-credentials'
