...
import type { ContentBlock, ToolSchema } from '@huiliyi37/dsh-llm'
...
import type { ContextBreakdownProjection } from '@huiliyi37/dsh-token-meter/client'
...
describe('shared estimator', () => {
  it('prices every content-block shape under the fixed heuristic', () => {
    ...
    expect(estimateContent([{ type: 'reasoning', text: 'abcdefgh' }] as Array<ContentBlock>)).toBe(6)
