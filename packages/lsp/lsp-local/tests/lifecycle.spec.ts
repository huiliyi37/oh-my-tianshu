...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@huiliyi37/dsh-lsp'
...
import type { LspLocalServerConfig } from '@huiliyi37/dsh-lsp-local'
