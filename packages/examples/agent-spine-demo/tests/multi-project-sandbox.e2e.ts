...
import { bwrapProfileArgs, seatbeltProfileArgs } from '@huiliyi37/dsh-sandbox-local/src/profiles.ts'
...
import type { ToolResult } from '@huiliyi37/dsh-tools'
import { launcherPath } from '@huiliyi37/node-addon-landlock-run'
