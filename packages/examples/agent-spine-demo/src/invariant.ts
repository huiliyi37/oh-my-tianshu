/**
 * Package-owned invariant companion for `@huiliyi37/dsh-agent-spine-demo`.
 * @module @huiliyi37/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-agent-spine-demo'
