/**
 * Package-owned invariant companion for `@huiliyi37/dsh-jsonrpc-demo`.
 * @module @huiliyi37/dsh-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-jsonrpc-demo'
