...
| `getOrCreateAnonymousId` | Random UUID persisted in the harness home resolved by [`@huiliyi37/dsh-paths`](../../util/paths/README.md) (`$DSH_HOME` > `~/.dsh`), scoped to that home rather than the machine, never derived from git. |
