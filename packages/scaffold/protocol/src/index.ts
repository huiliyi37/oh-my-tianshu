/**
 * Shared wire protocol for the Tianshu Harness SDK runtime: the
 ...
 * (`@huiliyi37/dsh-sdk-server`) serves this protocol; SDK clients
 * (`@huiliyi37/dsh-sdk-client`, the Python SDK) drive it.
 *
 * @module @huiliyi37/dsh-sdk-protocol
 */
