/**
 * Package-owned invariant companion for `@huiliyi37/dsh-sdk-protocol`.
 * @module @huiliyi37/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-sdk-protocol'
