...
The generated [`pwsh` schema](../../../docs/tool-catalog.md#huiliyi37dsh-tool-pwsh-persistent), including the configured `description`. The plugin contributes no standalone system-prompt section; the deployment owns persona and environment guidance.
