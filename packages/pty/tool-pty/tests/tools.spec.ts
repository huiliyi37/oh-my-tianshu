...
import ToolRegistry, { renderToolsSdk } from '@huiliyi37/dsh-tools'
import type { ToolSdkSchema } from '@huiliyi37/dsh-tools/src/ts-types.ts'
import PtyService, { PtySessionId } from '@huiliyi37/dsh-pty'
import type { PtyBackend, PtyBackendSession, PtySendOperation, PtySendRequest, PtySessionStatus, PtySignal } from '@huiliyi37/dsh-pty'
...
function stubBackend() {
  const sessions: Array<StubSession> = []
