/**
 * Package-owned invariant companion for `@huiliyi37/dsh-tool-bash-persistent`.
 * @module @huiliyi37/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@huiliyi37/dsh-tool-bash-persistent'
