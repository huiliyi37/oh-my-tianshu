...
export const CAPABILITY_GROUPS: readonly CapabilityGroup[] = [
  ...
  { id: 'fs-read', tools: ['read', 'read_section', 'read_image'], substitutable: true },
...
export const REAL_LAYERS: readonly FaceLayer[] = [
  { id: 'fs', tools: ['read', 'read_section', 'read_image', 'write', 'edit'], capabilities: ['fs-read', 'fs-write', 'fs-edit'] },
