...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  'apps/web/dist/**',
  '.artifacts/**',
  'python/sdk-runtime/src/deepseek_harness_runtime/runtime/dsh-sdk-server-agent-*/**',
...
function isTranslationSourceExcluded(file: string): boolean {
  ...
  return segments.some(segment => NON_SOURCE_DIRECTORIES.has(segment)
    ...
    || file.startsWith('python/sdk-runtime/src/deepseek_harness_runtime/runtime/dsh-sdk-server-agent-')
