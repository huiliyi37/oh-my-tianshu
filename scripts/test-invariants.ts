...
import { FiberState, Inject, RegistryService } from '@huiliyi37/cordis'
import type { Context, Plugin } from '@huiliyi37/cordis'
...
const MANUAL_INVARIANT_TEST_EXCEPTIONS = [
  ...
  // The tui composition lane boots agent-spine-demo through the Loader; the
  // spine mounts InvariantService itself, so the global host must stay out.
  '/packages/tui/tui/tests/loader-composition.spec.ts',
] as const
