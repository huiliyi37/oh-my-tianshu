...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@huiliyi37/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@huiliyi37/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@huiliyi37/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  timer: 'client-side dynamic-package timer service — packages/self-modification/cordis-client-runner/README.md owns the API',
 ...
 * scan reads EVERY `declare module '@huiliyi37/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ModelRole: 'core.md',
  ModelRoleSelection: 'core.md',
  AgentOptions: 'core.md',
  AgentStatus: 'core.md',
  ContentBlock: 'llm-streaming.md',
  ImageBlock: 'llm-streaming.md',
  ...
  AgentDefinitionCatalogSnapshot: 'subagent.md',
  AgentDefinitionLookupOptions: 'subagent.md',
  AgentDefinitionRegistration: 'subagent.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CordisInspectQueryRequest: 'cordis/event contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisInspectQueryResolved: 'cordis/event contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisPackage: 'dynamic-package dispatch contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisRequestResolved: 'cordis/event contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisRetracted: 'cordis/event contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  ...
  CordisInspectProviderManifest: 'Cordis inspect provider manifest is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisInspectProviderView: 'Cordis inspect provider view is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisInspectQueryResolution: 'Cordis inspect query result is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisInspectRequestId: 'Cordis inspect request identity is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisInspectResolveAck: 'Cordis inspect resolution acknowledgement is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisDynamicPackageId: 'dynamic Package identity is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisDynamicPluginId: 'dynamic Plugin identity is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisDynamicPluginRunId: 'dynamic Plugin run identity is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  CordisDynamicRunMode: 'dynamic Plugin activation mode is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisClientSource: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisDefineReceipt: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisDefineRequest: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisHostHalfResult: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisInventoryRow: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisInvokeResult: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisPackageInspection: 'dynamic Package source inspection is owned by packages/self-modification/cordis-host-runner/src/registry.ts',
  DynamicCordisPluginInspection: 'dynamic Plugin inspection is owned by packages/self-modification/cordis-host-runner/src/registry.ts',
  DynamicCordisReference: 'dynamic Plugin reference is owned by packages/self-modification/cordis-host-runner/src/registry.ts',
  DynamicCordisRenderFailure: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisResolveAck: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisRunResolution: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisRunResponse: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisSnapshotRow: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisStopResponse: 'dynamic Plugin stop result is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  DynamicCordisUndefineReceipt: 'dynamic-package payload contract is owned by packages/self-modification/cordis-host-runner/src/types.ts',
  HostCordisInspectProviderRegistration: 'Host inspect provider registration is owned by packages/self-modification/cordis-host-runner/src/inspect-registry.ts',
  JsonValue: 'JSON value union is owned by packages/core/session/src/json.ts',
  MessageFeedbackListRequest: 'message feedback request contract is owned by packages/feedback/message-feedback/src/types.ts',
  MessageFeedbackListResult: 'message feedback response contract is owned by packages/feedback/message-feedback/src/types.ts',
  MessageFeedbackPutRequest: 'message feedback request contract is owned by packages/feedback/message-feedback/src/types.ts',
  MessageFeedbackPutResult: 'message feedback response contract is owned by packages/feedback/message-feedback/src/types.ts',
  MessageFeedbackDeleteRequest: 'message feedback request contract is owned by packages/feedback/message-feedback/src/types.ts',
  ...
  WorkflowAgentEndWire: 'TUI-local wire subset of the owner payload is owned by packages/tui/tui/src/ui/app.ts',
