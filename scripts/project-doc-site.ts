...
const REPOSITORY_URL = 'https://github.com/huiliyi37/oh-my-tianshu'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/huiliyi37/oh-my-tianshu/${repositoryRef}/${path}${suffix}`
