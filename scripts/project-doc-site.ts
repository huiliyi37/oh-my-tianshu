...
const REPOSITORY_URL = 'https://github.com/huiliyi37/dsh-tianshu-build'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/huiliyi37/dsh-tianshu-build/${repositoryRef}/${path}${suffix}`
