...
const REPOSITORY_URL = 'https://github.com/huiliyi37/dsh-tianshu-tui'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/huiliyi37/dsh-tianshu-tui/${repositoryRef}/${path}${suffix}`
