...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  // tool-subagent's model-selection settings entry ships as its own bundle
  // (the ./model-selection-settings subpath composes it in the Host scope).
  // tsdown also shares its routing-schema code through a hashed runtime chunk.
  '@huiliyi37/dsh-tool-subagent': ['lib/model-selection-settings.js', 'lib/model-selection-*.js'],
