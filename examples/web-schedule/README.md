...
This overlay opts one `tianshu web` process into Schedule reminders without changing the shipped default Web composition:

```sh
tianshu web --patch examples/web-schedule/cordis.yml
```
